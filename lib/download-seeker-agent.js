...
async function run() {
    try {
        ...
        const technology = utils_1.getInputOrEnvironmentVariable('seekerAPIToken', 'SEEKER_API_TOKEN', true // required
        );
        const osFamily = utils_1.getInputOrEnvironmentVariable('osFamily', 'SEEKER_OS_FAMILY', true // required
        );
